...
var heroImages = ["foto-barong.png", "telaga-ngabel.jpg", "foto-batik.jpeg"];
...
function showResult() {
  ...
  if (nilai >= 90) {
    pesan =
      score +
      " benar dari 20 soal<br><strong>Luar Biasa! Kamu Ahli Budaya Ponorogo! 🏆</strong>";
  } else if (nilai >= 70) {
    pesan =
      score +
      " benar dari 20 soal<br><strong>Bagus! Terus pelajari budaya kita! 👍</strong>";
  } else if (nilai >= 50) {
    pesan =
      score +
      " benar dari 20 soal<br><strong>Lumayan! Masih ada ruang untuk belajar 📚</strong>";
  } else {
    pesan =
      score +
      " benar dari 20 soal<br><strong>Semangat! Mari pelajari Reog lebih dalam 💪</strong>";
  }
...
function updateHUD() {
  ...
  if (livesEl) {
    livesEl.textContent =
      "❤️".repeat(gLives) + "🖤".repeat(Math.max(0, 3 - gLives));
  }
}
...
function drawPlayer() {
  ...
  ctx.lineWidth = 1.5;
  ctx.beginPath();
  ctx.moveTo(px + player.w / 2 - 2, py + 16);
  ctx.lineTo(px + player.w / 2 - 8, py + 18);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(px + player.w / 2 + 2, py + 16);
  ctx.lineTo(px + player.w / 2 + 8, py + 18);
  ...
  ctx.beginPath();
  ctx.moveTo(px + player.w / 2 - 2, py + 16);
  ctx.lineTo(px + player.w / 2 - 8, py + 14);
  ctx.stroke();
  ctx.beginPath();
  ctx.moveTo(px + player.w / 2 + 2, py + 16);
  ctx.lineTo(px + player.w / 2 + 8, py + 14);
  ...
  ctx.quadraticCurveTo(
    ...
    py + 18,
    px + player.w + 30,
    py + 10 + Math.sin(frameCount * 0.15) * 8,
  );
  ctx.stroke();
...
function drawIdle() {
  ...
  ctx.fillText(
    'Klik tombol "Mulai Game" atau tekan SPASI untuk bermain',
    GW / 2,
    GH / 2 + 26,
  );
  ctx.fillText(
    "🎭 Kumpulkan topeng (+10 poin)    ⚔️ Hindari keris musuh",
    GW / 2,
    GH / 2 + 56,
  );
...
function drawGameOver() {
  ...
  ctx.fillText(
    'Klik "Mulai Game" atau tekan SPASI untuk bermain lagi',
    GW / 2,
    GH / 2 + 50,
  );
